...
import { useGetLearner, useCreateLearner, useUpdateLearner, useGetLearnerAllocationHistory, LearnerStatus, getGetLearnerQueryKey, getGetLearnerAllocationHistoryQueryKey } from "@workspace/api-client-react";
...
import { Loader2, Save, ArrowLeft, History, Calendar } from "lucide-react";
...
export default function LearnerDetailPage() {
  ...
  const onSubmit = (values: z.infer<typeof learnerSchema>) => {
    ...
    if (isNew) {
      ...
      updateMutation.mutate({ id: learnerId, data: payload }, {
        onSuccess: () => {
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl mx-auto w-full">
      ...
      <div className="flex items-center justify-between gap-4 mb-8 page-transition-enter">
        ...
        {!isNew && (
          <Button onClick={() => form.handleSubmit(onSubmit)()} disabled={isSaving} className="hover-elevate shadow-sm hidden sm:flex">
