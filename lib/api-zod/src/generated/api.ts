...
export const GetAttendanceSessionResponse = zod.object({
  ...
  "learnerName": zod.string(),
  "learnerRef": zod.string(),
  "status": zod.union([zod.enum(['present', 'absent_authorised', 'absent_unauthorised', 'late', 'not_expected', 'withdrawn', 'bil']),zod.null()]),
...
export const GetLearnerReportV2Response = zod.object({
  ...
  "cohortName": zod.string(),
  "tutorName": zod.string(),
  "status": zod.union([zod.enum(['present', 'absent_authorised', 'absent_unauthorised', 'late', 'not_expected', 'withdrawn', 'bil']),zod.null()]).describe('Null when no register row was ever recorded for this session -- missing data, never treated as absence.'),
